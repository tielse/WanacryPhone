...
public class MainAcvitiy_CustomProgressBar extends ProgressBar {

    Paint mPaint;
    String text;

    public MainAcvitiy_CustomProgressBar(Context context) {
        super(context);
        initText();
    }

    public MainAcvitiy_CustomProgressBar(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        initText();
    }

    public MainAcvitiy_CustomProgressBar(Context context, AttributeSet attributeSet, int i) {
